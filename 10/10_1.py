...
def find_end(prev_i, prev_j, i, j, score, found):
    ...
    if tmap[i][j] == 9:
        if (i, j) not in found:
            ...
            return 0
    return find_end(i, j, i - 1, j, score, found) + find_end(i, j, i + 1, j, score, found) + find_end(i, j, i, j - 1, score, found) + find_end(i, j, i, j + 1, score, found) 
